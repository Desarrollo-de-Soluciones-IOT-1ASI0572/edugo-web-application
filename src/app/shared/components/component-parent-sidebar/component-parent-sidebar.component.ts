...
@Component({
  selector: 'app-component-parent-sidebar',
  imports: [MatListModule, MatIconModule, RouterModule, TranslateModule],
  templateUrl: './component-parent-sidebar.component.html',
  styleUrl: './component-parent-sidebar.component.css'
})
export class ComponentParentSidebarComponent {
  userName = '';
  userRole = 'Padre';
  photoUrl = '';
